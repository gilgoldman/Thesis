...
A hydrometer was placed in each solution, with a negligibly light piece of paper weighing $3*10^{-6}$[kg] on its edge to assure accurate reading by the distance sensor. The hydrometers depth in each solution was measured by the systems standard of the average of 100 distance readings, which was then fed into the Main Module for the conversion to SG.\\
