...
The tests conducted in Chapter 5 proved sufficient to determine the accuracy of the HC-sr04 sensor and its appropriateness for use in this device.	The experiments conducted show an that, a few measurement errors aside, the sensors accuracy is 1[mm] or less when 26 measurements are taken, the optimal number of readings to be implemented are 100, and that the error in ABV prediction is **********.\\
