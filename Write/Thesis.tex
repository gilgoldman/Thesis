...
V této práci autor poskytuje přehled současných metod pro sledování fermentačních procesů při výrobě piva v minipivovarech. Dále implementuje a testuje automatické řešení pro monitorování graduální akumulace ethanodu v procesu fermentace piva.
\end{abstract-czech}
